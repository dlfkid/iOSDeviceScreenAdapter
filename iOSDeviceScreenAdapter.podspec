#
#  Be sure to run `pod spec lint iOSDeviceScreenAdapter.podspec' to ensure this is a
...
+ (NSString *)deviceTypeString;
  ...
  s.source_files  = "DeviceScreenAdaptor","ScreenAdapterDemo/ScreenAdapterDemo/ScreenAdapter/*.{h,m}"
